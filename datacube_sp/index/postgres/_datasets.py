...
from datacube_sp.drivers.postgres._fields import SimpleDocField, DateDocField
...
from datacube_sp.model.utils import flatten_datasets
...
class DatasetResource(AbstractDatasetResource, IndexResourceAddIn):
    ...
    def __init__(self, db, index):
        ...
        :type dataset_type_resource: datacube_sp.index._products.ProductResource
        """
        self._db = db
        self._index = index
