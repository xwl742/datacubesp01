...
from datacube_sp.index.memory._datasets import DatasetResource  # type: ignore
from datacube_sp.index.memory._fields import get_dataset_fields
...
from datacube_sp.index.memory._users import UserResource
