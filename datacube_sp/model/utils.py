...
from datacube_sp.utils import geometry, SimpleDocNav, InvalidDocException
...
def machine_info():
    info = {
        'software_versions': {
            ...
            'datacube_sp': {'version': datacube_sp.__version__,
...
def datasets_to_doc(output_datasets):
    ...
    :param output_datasets: An array of :class:`datacube_sp.model.Dataset`
...
def make_dataset(product, sources, extent, center_time, valid_data=None, uri=None, app_info=None,
    ...
    """
    Create :class:`datacube_sp.model.Dataset` for the data
