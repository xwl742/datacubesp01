...
def activate_rio_env(aws=None, cloud_defaults=False, **kwargs):
    ...
    if aws is not None:
        ...
        if region_name == "auto":
            from datacube_sp.utils.aws import auto_find_region
...
def configure_s3_access(
    ...
    **gdal_opts
    ...
    """
    Use :meth:`datacube_sp.utils.aws.configure_s3_access` instead.
    """
    from datacube_sp.utils.aws import configure_s3_access
