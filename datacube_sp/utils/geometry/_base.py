...
def assign_crs(xx: Union[xr.DataArray, xr.Dataset],
    ...
    information but not in the format used by datacube_sp, in this case CRS
    metadata will be restructured into a shape used by datacube_sp. This format
    allows for better propagation of CRS information through various
    computations.

    .. code-block:: python

        xx = datacube_sp.utils.geometry.assign_crs(xr.open_rasterio("some-file.tif"))
        print(xx.geobox)
