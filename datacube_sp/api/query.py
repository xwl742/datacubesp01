...
class Query(object):
    def __init__(self, index=None, product=None, geopolygon=None, like=None, **search_terms):
        ...
        Used by :meth:`datacube_sp.Datacube.find_datasets` and :meth:`datacube_sp.Datacube.load`.
...
def query_group_by(group_by='time', **kwargs):
    ...
    ::
        ...
        - time (default)
        - solar_day, see :func:`datacube_sp.api.query.solar_day`

    or ::

        - :class:`datacube_sp.api.query.GroupBy` object

    :return: :class:`datacube_sp.api.query.GroupBy`
