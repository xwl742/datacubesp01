...
from datacube_sp.utils.geometry import intersects
...
class Tile(object):
    """
    The Tile object holds a lightweight representation of a datacube_sp result.
    ...
    def __init__(self, sources, geobox):
        ...
        :param xarray.DataArray sources: An array of non-spatial dimensions of the request, holding lists of
            datacube_sp.storage.DatasetSource objects.
...
class GridWorkflow(object):
    ...
    def cell_observations(self, cell_index=None, geopolygon=None, tile_buffer=None, **indexers):
        ...
        :param datacube_sp.utils.Geometry geopolygon:
        ...
        :param indexers:
            Query to match the datasets, see :py:class:`datacube_sp.api.query.Query`
        :return: Datsets grouped by cell index
        :rtype: dict[(int,int), list[:py:class:`datacube.model.Dataset`]]

        .. seealso::
            :meth:`datacube_sp.Datacube.find_datasets`

            :class:`datacube_sp.api.query.Query`
        """
    ...
    def group_into_cells(observations, group_by):
        ...
        :param group_by: grouping method, as returned by :py:meth:`datacube_sp.api.query.query_group_by`
        ...
        .. seealso::
            ...
            :meth:`datacube_sp.Datacube.group_datasets`
        """
        cells = {}
    ...
    def list_cells(self, cell_index=None, **query):
        ...
        :meth:`datacube_sp.Datacube.load`.
        ...
        :param query: see :py:class:`datacube_sp.api.query.Query`
        :rtype: dict[(int, int), :class:`.Tile`]
        """
