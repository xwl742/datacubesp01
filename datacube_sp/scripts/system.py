...
from datacube_sp.drivers.postgres._connections import IndexSetupError
from datacube_sp.ui import click as ui
from datacube_sp.ui.click import cli, handle_exception
from datacube_sp.config import LocalConfig

_LOG = logging.getLogger('datacube_sp-system')
...
def check(local_config: LocalConfig):
    ...
    echo_field('Version', datacube_sp.__version__)
